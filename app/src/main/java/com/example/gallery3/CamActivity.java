...
//
//            boolean ishaveImage = (img.getDrawable() != null);
//
//            if (ishaveImage) {
//                try {
//                    sendRequest(POST, "upload", f);            // image available
//                } catch (IOException e) {
//                    e.printStackTrace();
//                }
//            } else {
//                Toast.makeText(this, "Image is not available", Toast.LENGTH_SHORT).show();// no image available
//            }
...
//    public void sendRequest(String method, String url, File file) throws IOException {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "com.example.gallery3.android.fileprovider",
                        photoFile);
